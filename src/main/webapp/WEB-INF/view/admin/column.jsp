...
<link href="https://fonts.googleapis.com/css2?family=Nanum+Brush+Script&display=swap" rel="stylesheet">
	...
	<main id="main">
    	<h3 class="hidden">컬럼 게시판 목록</h3>
            <form class="comForm" action="deleteColumn">
            <table class="comTable">
               ...
               <tbody>
                     ...
                     <tr>
                        ...
                        <td>${n.id}</td>
                        <td class="title indent text-align-left"><a href="/community/column/${n.id}">${n.title}</a></td>
                        <td>${n.writer}</td>
                        <td>
            ...
            <input type="submit" onclick="location.href='column'" value="삭제"><br><br>
            </form>
		...
		<ul class="pager">
			<c:forEach var="i" begin="1" end="${columnPage}">
