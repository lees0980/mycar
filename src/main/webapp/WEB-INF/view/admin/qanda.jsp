...
<link href="https://fonts.googleapis.com/css2?family=Nanum+Brush+Script&display=swap" rel="stylesheet">
	...
	<main id="main">
    	<h3 class="hidden">qanda 게시판 목록</h3>
            <form class="comForm" action="deleteQanda">
            <table class="comTable">
               ...
               <tbody>
                     ...
                     <tr>
                        ...
                        <td>${n.id}</td>
                        <td class="title indent text-align-left"><a href="/community/qanda/${n.id}">${n.title}</a></td>
                        <td>${n.writer}</td>
                        <td>
            ...
            <input type="submit" onclick="location.href='qanda'" value="삭제"><br><br>
            </form>
